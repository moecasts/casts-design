/** fork from: https://github.com/react-component/util/blob/master/src/React/render.ts */
...
export function render(node: React.ReactElement, container: ContainerType) {
  if (createRoot !== undefined) {
    ...
    console.log('debug1 modernRender');
    return;
  }

  console.log('debug1 legacyRender');
