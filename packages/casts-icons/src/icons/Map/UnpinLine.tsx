...
const UnpinLine = (initProps: IconProps) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="m20.97 17.172-1.414 1.414-3.535-3.535-.073.074-.707 3.536-1.415 1.414-4.242-4.243-4.95 4.95-1.414-1.414 4.95-4.95-4.243-4.243L5.34 8.761l3.536-.707.073-.074-3.536-3.536L6.828 3.03 20.97 17.171ZM10.365 9.394l-.502.502-2.822.565 6.5 6.5.564-2.822.502-.502-4.242-4.243Zm8.411.074-1.34 1.34 1.414 1.415 1.34-1.34.707.707 1.415-1.415-8.486-8.485-1.414 1.414.707.707-1.34 1.34 1.414 1.415 1.34-1.34 4.243 4.242Z" />
    </svg>
  );
};
export { UnpinLine };
