...
const WechatChannelsLine = (initProps: IconProps) => {
  ...
  const classes = clsx(
    `${prefixCls}`,
    `${prefixCls}-wechat-channels-line`,
    className,
  );
  return (
    <svg
