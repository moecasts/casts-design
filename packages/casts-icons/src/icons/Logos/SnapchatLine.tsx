...
const SnapchatLine = (initProps: IconProps) => {
  ...
  const classes = clsx(`${prefixCls}`, `${prefixCls}-snapchat-line`, className);
  return (
    <svg
